...
typedef struct image_desc_
{
  ...
  uint8_t *pBlue;  /* Référence sur le plan mémoire de couleur rouge  */
  
    /* Référence sur le plan mémoire de couleur bleue  */
  uint8_t *pGreen;
  
  /* Référence sur le plan mémoire de couleur verte  */
} image_desc ;
